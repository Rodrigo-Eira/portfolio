...
urlpatterns = [
    ...
    path('tfcs_novo_tfc', views.tfcs_novo_tfc_view, name='tfcs_novo_tfc'),
    path('tfcs_edita_tfc/<int:tfc_id>', views.tfcs_edita_tfc_view, name='tfcs_edita_tfc'),
    path('tfcs_apaga_tfc/<int:tfc_id>', views.tfcs_apaga_tfc_view, name='tfcs_apaga_tfc'),
